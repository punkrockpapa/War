$(document).ready(function() {
    ...
    if(computer.length == 0){
      ...
      $winner.css("color", "palevioletred");
    ...
    $draw.on('click', function() {
      $("#computerName").css("color", "rosybrown");
      $("#playerName").css("color", "rosybrown");
    ...
    function assign(){
      ...
      $player.css("border-color", "rosybrown");
      $computer.css("border-color", "rosybrown");
        ...
        function compareMath(){
         ...
         function mathCheck() {
           if (chosen == winner){
             ...
             audio.currentTime=0;
             audio1.play();
             $("#playerName").css("color", "palevioletred");
             $playerCount.html(player.length);
             playedCards=[];
             ...
             audio.currentTime=0;
             audio2.play();
             $("#computerName").css("color", "palevioletred");
             $computerCount.html(computer.length);
             playedCards=[];
           }
         }
    ...
    function greater(){
      ...
      if (number1 > number2) {
          $winner.html("Player Wins Round");
          $player.css("border-color", "palevioletred");
          for (i=0; i<playedCards.length; i++) {
            player.push(playedCards[i]);
          }
          $playerCount.html(player.length);
          ...
          $winner.html("Computer Wins Round");
          $computer.css("border-color", "palevioletred"); 
          for (i=0; i<playedCards.length; i++) {
            computer.push(playedCards[i]);
          }
          $computerCount.html(computer.length);
